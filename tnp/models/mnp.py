...
class MNPDecoder(nn.Module):
    """
    Currently unchaned from TNPDecoder
    """
    def __init__(
        self,
        z_decoder: nn.Module,
...
class MNPEncoder(nn.Module):
    def __init__(
        self,
        mamba_encoder: MNPDMambaEncoder,
...
class MNP(ConditionalNeuralProcess):
    def __init__(
        self,
        encoder: MNPEncoder,
        decoder: MNPDecoder,
